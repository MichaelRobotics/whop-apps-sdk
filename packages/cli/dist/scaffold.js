...
export function sampleCatalog(appId) {
    return parseCatalog({
        app_id: appId,
...
export function scaffoldFiles(options) {
    ...
    writeFileSync(serverPath, `import { createWhopGatewayApp } from "@whop-apps-gateway/app-sdk";
...
`);
    ...
    writeFileSync(readme, `# Gateway opt-in
...
export function parseArgs(argv) {
    ...
    for (let i = 0; i < rest.length; i++) {
        ...
        if (a === "--app-id")
            ...
            publicBaseUrl = rest[++i] ?? publicBaseUrl;
